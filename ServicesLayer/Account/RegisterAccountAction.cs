...
{
    public class RegisterAccountAction : BizActionStatus, IRegisterAccountAction
    {
        public IMapper AutoMapper;
        public UserManager<AppUser> UserManager;


        public RegisterAccountAction(IMapper autoMapper, UserManager<AppUser> userManager)
        {
